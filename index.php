...
<html lang="en">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
       <a class="p-2 text-muted" href="konten/tugas_pertama1.php">Tugas Pertama</a>
      <a class="p-2 text-muted" href="konten/tugas_kedua1.php">Tugas Kedua</a>
      <a class="p-2 text-muted" href="#">Tugas Ketiga</a>
  ...
  <div class="gif">
    <center><img src="./img/code.gif" width="400px"></center>
  </div>
